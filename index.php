        ...
        <section class="section_header">
            <div class="header_div">
                ...
                <ul class="header_list">
                    <!-- <li class="header_list_item"><a href="addNewSong.html">Добавить</a></li> -->
                    <!-- <li class="header_list_item"><a href="">пункт 2</a></li> -->
                </ul>
    ...
    <main>
        <section class="section">
            <div class="artist_div">
                <img class="artist_thumbnail" src="img/Korol_i_Shut.jpg" alt="">
        ...
        <div class="box_for_player">
            <!-- <div class="player">
                <input type="range" value="0" class="progressBar" id="progBar">

                <div class="controls_div">
                    <div class="controls">
                        <img src="icons/backward-fast-solid.svg" alt="" class="control_item">
                        <img src="icons/play-solid.svg" alt="" class="control_item" id="playBtn">
                        <img src="icons/forward-fast-solid.svg" alt="" class="control_item">
                    </div>
                    
                    <div class="player_thumbnail_div">
                        <img class="list_item_thumbnail" src="img/Ten_klouna.jpg" alt="">
                        <div>
                            <h3>Песня</h3>
                            <p>Король и шут</p>
                        </div>
                    ...
                    <div class="div_bar">
                        <img src="icons/volume-high-solid.svg" alt="">
                        <input type="range" value="0" class="volumeBar" id="volumeBar">
                    </div> 
                </div>
            </div> -->
        </div>
